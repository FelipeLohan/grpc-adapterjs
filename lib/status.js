...
function inferCode (err) {
  switch (err.name) {
    ...
    default:
      // mirrors finalhandler's default of 500: an unhandled exception is
      // an internal bug, not a client-facing "unknown" outcome
      return err instanceof Error ? status.INTERNAL : status.UNKNOWN
  }
}

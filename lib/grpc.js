...
exports.errorHandler = require('./router/error-handler').errorHandler

var protobufCodec = require('./codec/protobuf')
exports.load = protobufCodec.load
exports.loadSync = protobufCodec.loadSync
